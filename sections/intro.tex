...
\begin{columns}
	...
	Given a time series of satellite data $\M{x}=(\V{x}_1,\V{x}_2,\dots,\V{x}_T)$ which crop type $\V{y} \in {y_\text{corn},y_\text{meadow},\dots}$ is cultivated is on the field?
