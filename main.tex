...
%		Marc Rußwurm M.Sc. \\
%		\vspace{1em}
%		PhD Candidate at~\includegraphics[height=.9em]{images/TUM-blue}~Chair of Remote Sensing Technology
%	\end{center}
%	\vfill
%\end{frame}
%}
...
\visible<1->{\node[anchor=east, label=Earth Observation] at (0,0){\includegraphics[width=3cm]{images/epicw1}};}
